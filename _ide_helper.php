...
namespace Rebing\GraphQL\Support\Facades {
    ...
    class GraphQL {
         ...
         * @static 
         */
        public static function appendGlobalResolverMiddleware($class)
        {
            /** @var \Rebing\GraphQL\GraphQL $instance */
            return $instance->appendGlobalResolverMiddleware($class);
        }
         ...
         * @static 
         */
        public static function getGlobalResolverMiddlewares()
        {
            /** @var \Rebing\GraphQL\GraphQL $instance */
            return $instance->getGlobalResolverMiddlewares();
        }
